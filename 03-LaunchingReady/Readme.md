...
## Admin
### Login ( Same for Teacher & Student )
...
### Dashboard  ( Same for Teacher & Student but they have some disable buttons)
|Wireframe|Paper Prototype|
|:-----:|---------------------|
...
## For live Meeting
### Admin ( Same as Teacher and Student except Student can enter a meeting ID instread of email)
|Wireframe|Paper Prototype|
|:-----:|---------------------|
